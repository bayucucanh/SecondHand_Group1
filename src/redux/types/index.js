...
export const GET_BID_DETAIL_FAILED = '@GET_BID_DETAIL_FAILED';
...
export const GET_DETAIL_SELLER_PRODUCT_SUCCESS = '@GET_DETAIL_SELLER_PRODUCT_SUCCESS';
export const GET_DETAIL_SELLER_PRODUCT_FAILED = '@GGET_DETAIL_SELLER_PRODUCT_FAILED';
...
export const PATCH_NOTIFICATION_FAILED = '@PATCH_NOTIFICATION_FAILED';
...
export const GET_HISTORY_DETAIL_FAILED = '@GET_HISTORY_DETAIL_FAILED';

// Wishlist
export const GET_WISHLIST_SUCCESS = '@GET_WISHLIST_SUCCESS';
export const GET_WISHLIST_FAILED = '@GET_WISHLIST_FAILED';
export const GET_DETAIL_WISHLIST_SUCCESS = '@GET_DETAIL_WISHLIST_SUCCESS';
export const GET_DETAIL_WISHLIST_FAILED = '@GET_DETAIL_WISHLIST_FAILED';
